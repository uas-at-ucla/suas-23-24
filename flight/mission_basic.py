...
mission_basic.py: Example demonstrating basic mission operations including
creating, clearing and monitoring missions.
...
parser.add_argument(
    "--connect",
    help=(
        "vehicle connection target string. If not specified, SITL"
...
def get_location_metres(original_location, dNorth, dEast):
    ...
    except close to the poles. For more information see:
...
def adds_square_mission(aLocation, aSize):
    ...
    # Add new commands. The meaning/order of the parameters
    # is documented in the Command class.
    ...
    # add dummy waypoint "5" at point 4
    # (lets us know when have reached destination)
    cmds.add(
        Command(
            0,
            0,
...
while True:
    ...
    if (
        nextwaypoint == 5
    ):  # Dummy waypoint - as soon as we reach waypoint 4 this is true
        # and we exit.
        print(
